## Activity File: Implementing Security Controls
...
- Consider _physical_, _technical_, or _procedural_ controls that would immediately reduce employee tailgaiting.
