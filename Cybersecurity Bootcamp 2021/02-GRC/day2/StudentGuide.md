...
- The lesson slides are available on Google Drive here: [2.2 Slides](docs.google.com/presentation/d/1zdFhu7ebOYK48VGT70gz582C29YVfMRJddIKGRInqbs).
...
- [Activity File: Threat Modeling, Steps 1-4](Activities/01_Threat_Modeling_Steps_1_4/Unsolved/README.md)

### 04. Activity Review: Threat Modeling, Steps 1-4 

- [Solution Guide: Threat Modeling, Steps 1-4](Activities/01_Threat_Modeling_Steps_1_4/Solved/README.md)
...
- **Single loss expectancy** is the estimated cost of the occurrence of a risk on a given asset. 
  ...
  - SLE is the estimated cost for each time the risk occurs. If it happens twice, the total cost would be twice the SLE.

- **Annual loss expectancy** is the metric determining the cost of a risk reoccurring. 
...
- **Annual rate of occurrence** is an estimate of how many times a risk is likely to occur in a given year.
  ...
  - For example: You might assume a physical break-in will only happen once a year, at most. However, you should guess that phishing attacks will happen as often as once a month.
...
- A **heat map** is used to compare how many of the risks an organization faces are low probability but high impact vs. how many are high probability but low impact.

At least these two charts are usually included with a risk analysis.

#### Demonstration: The Risk Spreadsheet

*Note:* For this portion, you will need to have Microsoft Excel or Libre, a free, comparable tool, in order to load the risk analysis template. 
...
- [Activity File: Threat Modeling Step 5, Risk Analysis](Activities/02_Risk_Analysis/Unsolved/README.md)

### 08. Activity Review: Threat Modeling Step 5, Risk Analysis 

- [Solution Guide: Threat Modeling Step 5, Risk Analysis](Activities/02_Risk_Analysis/solved/README.md)
...
### 10. Activity: Threat Modeling Step 6, Risk Analysis

- [Activity File: Threat Modeling Step 6, Risk Analysis](Activities/03_Mitigating_Risk/Unsolved/README.md)

### 11. Activity Review: Threat Modeling Step 6, Risk Analysis
 - [Solution Guide: Threat Modeling Step 6, Risk Analysis](Activities/03_Mitigating_Risk/Solved/README.md)
