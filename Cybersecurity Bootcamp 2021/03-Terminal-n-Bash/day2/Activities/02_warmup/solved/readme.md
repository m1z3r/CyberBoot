...
- The first step is to navigate into the `Cybersecurity-Lesson-Plans/03-Terminal/student_day2/warmup/` folder on your VM. To do this, run the following command:

     - `cd Cybersecurity-Lesson-Plans/03-Terminal/student_day2/warmup/`
...
- Within this folder are six physical access logs. To view the contents, run preview commands (`head`, `more` or `less`) to find out which contain the data for October 13th. For example:
 ...
 - Lastly, we need to move this new file over to the `additional_evidence` folder. We will do this using absolute paths:
    ...
    - `Cybersecurity-Lesson-Plans/03-Terminal/student_day2/warmup/physical_access_logs/Physical_Access_evidence /home/sysadmin/Cybersecurity-Lesson-Plans/03-Terminal/student_day2/warmup/`
