...
- :warning: **Heads Up**: You will **not** be using your cyberxsecurity accounts during these weeks. You must create and set up a new Azure account to use for the next two weeks.

Please have your account ready before the beginning of next week to avoid having to troubleshoot in class. This [Setup Guide](https://docs.google.com/document/d/1gs_09b7eotl7hzTL82xlqPt-OwOd0aWA78qcQxtMr6Y/edit) will guide you through the Azure account setup.
